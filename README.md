...
| 🧠 **Agentic-RAG: Production-Grade AI Backend**   *(No Frameworks)* | `FastAPI` `Cross-Encoder` `Llama 3 (Groq)` `FAISS/BM25` `Custom State Machine` | [![Repo](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github)](https://github.com/debarnabdas007/Agentic-RAG-) &nbsp; [![Demo](https://img.shields.io/badge/Demo-YouTube-FF0000?style=flat-square&logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=mV9ksCoA5Xs) |
